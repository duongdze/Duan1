...
<main class="wrapper">
    <div class="main-content">
        <div class="page-header">
            <h1 class="h2">Chỉnh Sửa Phiên Bản Tour</h1>
            <p class="text-muted">
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0"><i class="fas fa-edit me-2"></i>Thông Tin Phiên Bản</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="?action=tours_versions/update" id="versionForm">
                    <input type="hidden" name="id" value="<?= htmlspecialchars($version_id) ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   required
                                   value="<?= htmlspecialchars($version['name'] ?? '') ?>">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" 
                                   name="start_date" 
                                   class="form-control"
                                   value="<?= htmlspecialchars($version['start_date'] ?? '') ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">
                            ...
                            <input type="date" 
                                   name="end_date" 
                                   class="form-control"
                                   value="<?= htmlspecialchars($version['end_date'] ?? '') ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   step="1000"
                                   placeholder="0"
                                   value="<?= htmlspecialchars($version['price'] ?? '') ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="notes" 
                                      class="form-control" 
                                      rows="4"
                                      placeholder="Thông tin bổ sung về phiên bản này..."><?= htmlspecialchars($version['notes'] ?? '') ?></textarea>
                        </div>
                    </div>
